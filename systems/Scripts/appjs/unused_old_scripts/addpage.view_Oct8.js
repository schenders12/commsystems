   ...
   // }); // droppable
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            // $("ul.draggables > li").click(function (event) {
             $("#draggables > li").click(function (event) {
    ...
    $("#draggables").droppable({    
        drop: function(ev, ui) {
            ...
            {            
                ...
                $clone.addClass('ui-widget-content ui-corner-tr');
                initDraggable($clone);
                $(this).append($clone);
                // Chang icon to plus sign
                removeModule($clone);
...
// Function to initialize draggable elements (modules)
function initDraggable($element)
 ...
 // Initialize page - Droppable and Sortable
function initDroppableSort($element) {
    $element.droppable({
        activeClass: "ui-state-highlight",
        drop: function (event, ui) {
           // addModule(ui.draggable);
           // var remove_icon = "<a href='' title='Remove this module' class='ui-icon ui-icon-close' style='float:right;'>Remove Module</a>";
            // Remove the plus icon from the draggable item
          //  $(ui.draggable).find("a.ui-icon-plus").remove();
            // Add the remove icon from the draggable item
          //  $(ui.draggable).append(remove_icon);
            // Add a hidden element for MVC
          //  var draggId = $(ui.draggable).attr('id');
          //  var moduleHidden = '<input id="' + draggId + '" name="addMe" type ="hidden" value="' + draggId + '">';
          //  $(ui.draggable).append(moduleHidden);
        }
    });
    $element.sortable({
        items: 'li',
