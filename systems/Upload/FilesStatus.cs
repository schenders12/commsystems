...
namespace systems.Upload
{
    public class FilesStatus
    {
        ...
        public FilesStatus(FileInfo fileInfo, string profileId) { SetValues(fileInfo.Name, (int)fileInfo.Length, fileInfo.FullName, profileId); }

        public FilesStatus(string fileName, int fileLength, string fullPath, string profileId) { SetValues(fileName, fileLength, fullPath, profileId); }

        private void SetValues(string fileName, int fileLength, string fullPath, string profileId)
        {
            name = fileName;
            type = "image/png";
            size = fileLength;
